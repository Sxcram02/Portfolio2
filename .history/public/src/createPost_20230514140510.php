...
$execute = $prepare -> bindParam("client",$resultado);
$prepare -> execute();
$arrayDatabase= $prepare -> fetchAll(PDO::FETCH_CLASS,"clients");

$dataUsersInfo = array();

foreach ($arrayDatabase as $client){
    $dataUsersInfo=$client['clientName']
}
