<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == "post"){
        ...
        $resultQueryGet = $databaseConnect -> getUser();
        if($resultQueryGet){
            session_unset()
            $_SESSION['client']="boss";
...
<body>
    <div class="page2-root">
        <header class="box-nav-bar">
            ...
            <nav class="nav-bar">
                <ul>
                    <li><a href="/index.php/#root">Home Page</a></li>
                    <li><a href="/index.php/#title2">Work</a></li>
        ...
        <main class="page2-container">
            <h1 class="page2-title">LOGIN</h1>
                <section class="page2-target">
                    <label>Usuario: </label>
                    <input type="text" name="client" id="inputUser" placeholder="<?php echo $_SESSION['user']?>">
