...
$mysqlDataBase = new PDO::__construct("mysql:dbname='blog':host='localhost'","root","mdv21.389863");
$mysqlDataBase -> prepare("SELECT usr.clientName as client FROM users usr WHERE client = ?;");
$mysqlDataBase -> ;
