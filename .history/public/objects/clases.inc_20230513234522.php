    ...
    class Database {
        ...
        {
                $mySqlConnection = $this -> newObjMysql;
                $getQuery = "SELECT blg.imagen as imagen, blg.titulo as titulo, blg.descripcion as descripcion, blg.subtitulo as subtitulo, blg.user user FROM blog blg JOIN users usr ON blg.user = usr.clientName WHERE usr.clientName = 'marcos';";
